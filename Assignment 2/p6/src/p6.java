public class p6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(TextBox, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(58, 58, 58)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        v1 = Double.parseDouble(TextBox.getText());
        TextBox.setText("");
        operator = "%";
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        TextBox.setText(TextBox.getText() + "00");
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        v2 = Double.parseDouble(TextBox.getText());
        
        switch(operator){
            case "%":
                TextBox.setText(String.valueOf((v1/100) * v2));
                break;
            case "x^2":
                double result = 1;
                for(int i=1;i<=v2;i++){
            ...
            case "/":
                if(v2 == 0){
                    TextBox.setText("Cant Divide By Zero");
                }
                else{
                    TextBox.setText(String.valueOf(v1/v2));
                }
                break;
            case "*":
                TextBox.setText(String.valueOf(v1*v2));
