...
public class p6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Employee Record");
    ...
    private void searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyReleased
        try{
            con = dbconnection();
            pst = con.prepareStatement("SELECT * FROM emp WHERE id LIKE ? OR name LIKE ? OR salary LIKE ? OR designation LIKE ? OR department LIKE ?");
