...
public class PatientLogin extends javax.swing.JFrame {
    ...
    private void Login_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Login_buttonActionPerformed
       ...
       try{
           ...
           pst = con.prepareStatement("select id from patients where id = ?");
           pst.setString(1,ID);
           rs = pst.executeQuery();
           rs.next();
           String id = rs.getString(1);
           
           pst = con.prepareStatement("select password from patients where password = ?");
           ...
           if(ID.equals(id) && PASS.equals(pass)){
               new ViewBill(ID).setVisible(true);
               dispose();
           }
           else{
