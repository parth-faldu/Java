...
public class ViewBill extends javax.swing.JFrame {
    ...
    public void fetchdata(){
        try{
            pst = con.prepareStatement("select id,name,`medical history`,bill from patients where id = ?");
            pst.setString(1,id);
            ...
            String MedicalHistory = rs.getString(3);
            String bill = rs.getString(4);
